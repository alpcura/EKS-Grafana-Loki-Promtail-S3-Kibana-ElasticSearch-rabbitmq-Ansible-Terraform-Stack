...
# CLI gerçekten hangi hesabı kullanıyor?
aws sts get-caller-identity

# Terraform tarafı (aynı profil/bölge)
terraform init -reconfigure
terraform plan -var="aws_profile=$AWS_PROFILE" -var="region=$AWS_REGION"

# Plan çıktıktan sonra Terraform’un gördüğü hesap:
terraform apply -auto-approve -var="aws_profile=$AWS_PROFILE" -var="region=$AWS_REGION"
